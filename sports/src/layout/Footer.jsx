...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#2c4167] text-white py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:space-x-8">
        {/* Left Section - Logo & Description */}
        <div className="flex-1">
          <Link to="/">
            <img
              className="w-[65%] md:w-[80%] lg:w-[40%] md:pl-[10%] lg:pl-[17%]"
              src="/heathcarelogofooter.png"
              alt="Logo"
            />
          </Link>
        ...
        <div className="flex-1">
          <div className="bg-[#2c4167] text-white pb-6 pr-6 rounded-lg w-full max-w-md">
      ...
      <div className="w-full bg-[#2c4167] text-white border-t-2 flex justify-center text-[20px] items-center pt-3 h-auto mt-4">
